<h2><a href="https://www.geeksforgeeks.org/problems/consecutive-array-elements2711/1?page=3&difficulty=Easy&sortBy=difficulty">Consecutive Array Elements</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an unsorted array&nbsp;<strong>arr</strong>. Find whether the array consists of consecutive numbers or not.</span></p>
